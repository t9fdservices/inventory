...
<ul class="nav nav-tabs">
    <li class="active"><a href="#instock" data-toggle="tab">In Stock</a>
    </li>
    <li><a href="#outofstock" data-toggle="tab">Out of Stock</a>
    </li>
    
    <li><a  href="#addstock" data-toggle="modal" data-target="#addstock">Add Stock</a>
    </li>
</ul>

<!-- Tab panes -->
<div class="tab-content">
    <div class="tab-pane fade in active" id="instock">
        <h4>In Stock</h4>
...
?>
    ...
    $query = "SELECT id, itemname, itemnumber,  itemstockcount, itemlocation, discription FROM stock WHERE itemstockcount<='0'"; 
...
?>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Out of Stock Inventory <small><button class="btn btn-success btn-xs" style="float: right;" data-toggle="modal" data-target="#addstock"> Add Stock </button></small>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="inventory">
